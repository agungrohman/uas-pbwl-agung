    ...
    <div class="container">
        ...
        <form action="<?php echo e(url('/pelanggan/' .$row->pel_id)); ?>" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="pel_ktp" class="form-control" value="<?php echo e($row->pel_hp); ?>">
            </div>
            <div class="mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pbwl-quiz-laravel-agung\resources\views/pelanggan/edit.blade.php ENDPATH**/ ?>