...
<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <?php endif; ?>
        <a class="btn btn-info btn-sm float-end" href="<?php echo e(url('pelanggan/create')); ?>">Tambah Data</a>
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td><a class="btn btn-dark btn-sm float" href="<?php echo e(url('pelanggan/' .$row->pel_id. '/edit')); ?>">Edit</a></td>
                <td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pbwl-quiz-laravel-agung\resources\views/pelanggan/index.blade.php ENDPATH**/ ?>